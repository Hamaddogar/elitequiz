...
import { getProperty, LoadWebSettingsDataApi, websettingsData } from "./store/reducers/webSettings";
...
const App = () => {
    ...
    const rtl_support = websettingsdata && getProperty(websettingsdata, 'rtl_support');
