...
const Header = () => {
    ...
    // sticky logo
    const stickylogoimage = websettingsdata && getProperty(websettingsdata, 'sticky_header_logo');

    // logo
    const logoimage = websettingsdata && getProperty(websettingsdata, 'header_logo');
