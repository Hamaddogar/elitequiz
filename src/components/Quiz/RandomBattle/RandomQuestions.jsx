        ...
        documentRef.onSnapshot(
            (doc) => {
                ...
                if (doc.exists) {
                    ...
                    let usersuid = [user1uid, user2uid];

                    let newArray = newUser.filter((obj) => Object.keys(obj.uid).length > 0);
                    ...
                    if (usersuid.includes(userData.data.id) && newArray.length < 2) {
                        ...
                        // creater coin deduct
                        const status1 = 1;
                        UserCoinScoreApi("-" + entryFee, null, null, (t("Played Battle")), status1, (response) => {
                            getusercoinsApi((responseData) => {
                                updateUserDataInfo(responseData.data)
                            }, (error) => {
                                console.log(error);
                        ...
                        // creater get coin if user2 left the screen
                        const status2 = 0;
                        UserCoinScoreApi(entryFee, null, null, (t("Won Battle")), status2, (response) => {
                            getusercoinsApi((responseData) => {
                                updateUserDataInfo(responseData.data)
                            }, (error) => {
                                console.log(error);
                    ...
                    if (navigatetoresult) {
                        ...
                        // coins update
                        if (usersuid.includes(userData.data.id) && user1point > user2point) {
                            const status = 0;
                            UserCoinScoreApi((entryFee + entryFee), null, null, (t("Won Battle")), status, (response) => {
                                getusercoinsApi((responseData) => {
                                    updateUserDataInfo(responseData.data)
                                }, (error) => {
                                    console.log(error);
                        ...
                        }else if (usersuid.includes(userData.data.id) && user1point == user2point) {
                            const status = 0;
                            UserCoinScoreApi(entryFee, null, null, (t("Draw")), status, (response) => {
                                getusercoinsApi((responseData) => {
                                    updateUserDataInfo(responseData.data)
                                }, (error) => {
                                    console.log(error);
                            ...
                            const status = 1;
                            UserCoinScoreApi("-" + entryFee, null, null, (t("Played Battle")), status, (response) => {
                                getusercoinsApi((responseData) => {
                                    updateUserDataInfo(responseData.data)
                                }, (error) => {
                                    console.log(error);
