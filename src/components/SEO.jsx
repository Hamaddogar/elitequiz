...
import { getProperty, websettingsData } from "../store/reducers/webSettings.js";
...
const SEO = ({ title }) => {
    ...
    // favicon
    const faviconimage = websettingsdata && getProperty(websettingsdata, 'faviconimage');

    // description
    const description = websettingsdata && getProperty(websettingsdata, 'description');

    // meta keywords
    const metakeywords = websettingsdata && getProperty(websettingsdata, 'metakeywords');
