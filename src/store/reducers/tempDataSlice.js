...
export const {tempdataSuccess,contestLeaderboarddataSuccess,playwithFrienddataSuccess,exammarksSuccess,examcompletedataSuccess,examsetquizSuccess} = tempSlice.actions;
