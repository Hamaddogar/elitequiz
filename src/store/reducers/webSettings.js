...
// Utility function to get a property from an object, with a default value if it doesn't exist
export const getProperty = (data, propName) => {
    return data.find(item => item[propName])?.[propName] || "";
};
