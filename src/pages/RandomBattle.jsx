        ...
        try {
            ...
            return db.runTransaction(async (transaction) => {
                ...
                if (user2.uid === "") {
                    ...
                    // join user2 coin deduct for join room
                    const status = 1;
                    UserCoinScoreApi("-" + userdetails.entryFee, null, null, (t("Played Battle")), status, (response) => {
                                    ...
                                    <div className="main_screen">
                                        ...
                                        <div className="inner_Screen onevsonescreen">
                                            <div className="user_profile">
                                                ...
                                                <p className="mt-3 text-dark">{userData.data.name ? userData.data.name : userData.data.email}</p>
                                            </div>
