...
const Quizplay = ({ t }) => {
    ...
    // quiz feature image
    const quiz_zone_icon = websettingsdata && getProperty(websettingsdata, 'quiz_zone_icon');
    const daily_quiz_icon = websettingsdata && getProperty(websettingsdata, 'daily_quiz_icon');
    const true_false_icon = websettingsdata && getProperty(websettingsdata, 'true_false_icon');
    const fun_learn_icon = websettingsdata && getProperty(websettingsdata, 'fun_learn_icon');
    const self_challange_icon = websettingsdata && getProperty(websettingsdata, 'self_challange_icon');
    const contest_play_icon = websettingsdata && getProperty(websettingsdata, 'contest_play_icon');
    const one_one_battle_icon = websettingsdata && getProperty(websettingsdata, 'one_one_battle_icon');
    const group_battle_icon = websettingsdata && getProperty(websettingsdata, 'group_battle_icon');
    const audio_question_icon = websettingsdata && getProperty(websettingsdata, 'audio_question_icon');
    const math_mania_icon = websettingsdata && getProperty(websettingsdata, 'math_mania_icon');
    const exam_icon = websettingsdata && getProperty(websettingsdata, 'exam_icon');
    const guess_the_word_icon = websettingsdata && getProperty(websettingsdata, 'guess_the_word_icon');
