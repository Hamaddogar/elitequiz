...
import { FaCamera,FaEnvelopeOpenText,FaMobileAlt, FaRegBookmark, FaSignOutAlt, FaTrashAlt, FaUserCircle } from "react-icons/fa";
                                ...
                                <div className="col-xl-5 col-lg-4 col-md-12 col-12 ">
                                    <div className="row card main__profile d-flex justify-content-center align-items-center">
                                        <div className="prop__image justify-content-center">
                                            <img src={process.env.PUBLIC_URL + "/images/user.svg"} alt="profile" id="user_profile" onError={imgError} />
                                                    ...
                                                    return (
                                                        <SwiperSlide key={key}>
                                                            <div className="pt-2 image_section">
                                                                <img src={process.env.PUBLIC_URL + elem.img} alt="profile" onClick={(e) => guestLogout(e)} data-file={elem.img.split('/').pop()}/>
                                                            </div>
                                                        </SwiperSlide>
                                                    );
                                                })}
                                            ...
                                            <div className="row">
                                                <div className="col-md-6 col-12">
                                                    <div className="bookmark__content common_content">
                                                        <NavLink onClick={(e) => guestLogout(e)} className="w-100 d-block">
                                            ...
                                            <div className="row">
                                                <div className="col-md-6 col-12">
                                                    <div className="share_app common_content">
                                                        <NavLink className="w-100 d-block" onClick={(e) => guestLogout(e)}>
